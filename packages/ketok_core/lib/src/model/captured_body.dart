...
enum BodyKind {
  ...
  /// the stream itself is never consumed by Ketok.
  stream,
}

/// An immutable, size-capped capture of a request or response body.
///
/// Ketok never keeps more than [defaultMaxBytes] (or a caller-supplied cap)
...
/// what keeps Ketok safe to leave enabled against large-body production
