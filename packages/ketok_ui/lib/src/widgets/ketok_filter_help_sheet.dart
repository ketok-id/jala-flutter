...
/// Bottom sheet documenting the `KetokFilter` grammar, opened from the
/// filter bar's help icon.
class KetokFilterHelpSheet extends StatelessWidget {
  /// Creates the filter grammar help sheet.
  const KetokFilterHelpSheet({super.key});
