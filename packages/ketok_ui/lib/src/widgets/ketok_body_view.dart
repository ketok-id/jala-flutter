...
import 'ketok_json_tree.dart';

/// Renders a [CapturedBody] according to its [BodyKind].
class KetokBodyView extends StatelessWidget {
  /// Creates a body view for [body].
  const KetokBodyView({required this.body, super.key});
    ...
    switch (body.kind) {
      ...
      case BodyKind.json:
        ...
        try {
          ...
          return KetokJsonTree(data: decoded);
        } on FormatException {
